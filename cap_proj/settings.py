"""
Django settings for cap_proj project.
...
SECRET_KEY = 'p5do#uhp-nc+ia!uj0$o_@kt6fmyc2h+3b=pwvx_k2dz!f^a*y'
...
WSGI_APPLICATION = 'cap_proj.wsgi.application'
